...
{
    template <typename Constructor, typename Allocator> order_history_object(Constructor&& c, allocator<Allocator> a)
    {
        c(*this);
    }
...
FC_REFLECT(
    scorum::market_history::bucket_object, (id)(open)(seconds)(high_scorum)(high_sbd)(low_scorum)(low_sbd)(open_scorum)(
                                               open_sbd)(close_scorum)(close_sbd)(scorum_volume)(sbd_volume))
CHAINBASE_SET_INDEX_TYPE(scorum::market_history::bucket_object, scorum::market_history::bucket_index)

FC_REFLECT(scorum::market_history::order_history_object, (id)(time)(op))
