...
struct market_ticker
{
    ...
    asset scorum_volume = asset(0, SCORUM_SYMBOL);
...
public:
    ...
    /**
     * @brief Returns the market ticker for the internal SBD:SCORUM market
     */
    ...
    /**
     * @brief Returns the current order book for the internal SBD:SCORUM market.
    ...
    /**
     * @brief Returns the trade history for the internal SBD:SCORUM market.
    ...
    /**
     * @brief Returns the N most recent trades for the internal SBD:SCORUM market.
    ...
    /**
     * @brief Returns the market history for the internal SBD:SCORUM market.
     * @param bucket_seconds The size of buckets the history is broken into. The bucket size must be configured in the
     * plugin options.
     ...
     */
    std::vector<bucket_object> get_market_history(
...
FC_REFLECT(scorum::market_history::market_ticker,
    (latest)(lowest_ask)(highest_bid)(percent_change)(scorum_volume)(sbd_volume));
FC_REFLECT(scorum::market_history::market_volume, (scorum_volume)(sbd_volume));
FC_REFLECT(scorum::market_history::order, (price)(scorum)(sbd));
FC_REFLECT(scorum::market_history::order_book, (bids)(asks));
FC_REFLECT(scorum::market_history::market_trade, (date)(current_pays)(open_pays));

FC_API(
    scorum::market_history::market_history_api, (get_ticker)(get_volume)(get_order_book)(get_trade_history)(
