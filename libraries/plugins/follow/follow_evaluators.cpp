...
void follow_evaluator::do_apply(const follow_operation& o)
{
    ...
    //        const auto& idx =
    //        _db._temporary_public_impl().get_index<follow_index>().indices().get<by_follower_following>();
...
void reblog_evaluator::do_apply(const reblog_operation& o)
{
    ...
    //        const auto& blog_comment_idx =
    //        _db._temporary_public_impl().get_index<blog_index>().indices().get<by_comment>();
    ...
    //        const auto& comment_idx =
    //        _db._temporary_public_impl().get_index<feed_index>().indices().get<by_comment>();
    //        const auto& idx =
    //        _db._temporary_public_impl().get_index<follow_index>().indices().get<by_following_follower>();
