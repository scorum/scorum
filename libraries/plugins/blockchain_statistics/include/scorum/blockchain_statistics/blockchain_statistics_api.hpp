...
FC_REFLECT(
    ...
    (blocks)(bandwidth)(operations)(transactions)(transfers)(scorum_transferred)(sbd_transferred)(sbd_paid_as_interest)(
        ...
        total_reply_votes)(new_reply_votes)(changed_reply_votes)(payouts)(sbd_paid_to_authors)(vests_paid_to_authors)(
        vests_paid_to_curators)(liquidity_rewards_paid)(transfers_to_vesting)(scorum_vested)(
