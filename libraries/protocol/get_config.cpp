...
fc::variant_object get_config()
{
   ...
   result["SCORUM_ACTIVE_CHALLENGE_COOLDOWN"] = SCORUM_ACTIVE_CHALLENGE_COOLDOWN;
   result["SCORUM_ACTIVE_CHALLENGE_FEE"] = SCORUM_ACTIVE_CHALLENGE_FEE;
   ...
   result["SCORUM_CASHOUT_WINDOW_SECONDS_PRE_HF12"] = SCORUM_CASHOUT_WINDOW_SECONDS_PRE_HF12;
   result["SCORUM_CASHOUT_WINDOW_SECONDS_PRE_HF17"] = SCORUM_CASHOUT_WINDOW_SECONDS_PRE_HF17;
   ...
   result["SCORUM_CONTENT_CONSTANT_HF0"] = SCORUM_CONTENT_CONSTANT_HF0;
   result["SCORUM_CONTENT_REWARD_PERCENT"] = SCORUM_CONTENT_REWARD_PERCENT;
   result["SCORUM_CONVERSION_DELAY"] = SCORUM_CONVERSION_DELAY;
   result["SCORUM_CONVERSION_DELAY_PRE_HF_16"] = SCORUM_CONVERSION_DELAY_PRE_HF_16;
   ...
   result["SCORUM_CURATE_APR_PERCENT"] = SCORUM_CURATE_APR_PERCENT;
   result["SCORUM_DEFAULT_SBD_INTEREST_RATE"] = SCORUM_DEFAULT_SBD_INTEREST_RATE;
   result["SCORUM_EQUIHASH_K"] = SCORUM_EQUIHASH_K;
   result["SCORUM_EQUIHASH_N"] = SCORUM_EQUIHASH_N;
   result["SCORUM_FEED_HISTORY_WINDOW"] = SCORUM_FEED_HISTORY_WINDOW;
   result["SCORUM_FEED_HISTORY_WINDOW_PRE_HF_16"] = SCORUM_FEED_HISTORY_WINDOW_PRE_HF_16;
   result["SCORUM_FEED_INTERVAL_BLOCKS"] = SCORUM_FEED_INTERVAL_BLOCKS;
   result["SCORUM_FREE_TRANSACTIONS_WITH_NEW_ACCOUNT"] = SCORUM_FREE_TRANSACTIONS_WITH_NEW_ACCOUNT;
   ...
   result["SCORUM_INIT_MINER_NAME"] = SCORUM_INIT_MINER_NAME;
   ...
   result["SCORUM_LIQUIDITY_REWARD_BLOCKS"] = SCORUM_LIQUIDITY_REWARD_BLOCKS;
   result["SCORUM_LIQUIDITY_REWARD_PERIOD_SEC"] = SCORUM_LIQUIDITY_REWARD_PERIOD_SEC;
   result["SCORUM_LIQUIDITY_TIMEOUT_SEC"] = SCORUM_LIQUIDITY_TIMEOUT_SEC;
   ...
   result["SCORUM_MAX_CASHOUT_WINDOW_SECONDS"] = SCORUM_MAX_CASHOUT_WINDOW_SECONDS;
   result["SCORUM_MAX_COMMENT_DEPTH"] = SCORUM_MAX_COMMENT_DEPTH;
   result["SCORUM_MAX_COMMENT_DEPTH_PRE_HF17"] = SCORUM_MAX_COMMENT_DEPTH_PRE_HF17;
   ...
   result["SCORUM_MAX_MINER_WITNESSES_HF0"] = SCORUM_MAX_MINER_WITNESSES_HF0;
   result["SCORUM_MAX_MINER_WITNESSES_HF17"] = SCORUM_MAX_MINER_WITNESSES_HF17;
   ...
   result["SCORUM_MAX_RATION_DECAY_RATE"] = SCORUM_MAX_RATION_DECAY_RATE;
   result["SCORUM_MAX_RESERVE_RATIO"] = SCORUM_MAX_RESERVE_RATIO;
   result["SCORUM_MAX_RUNNER_WITNESSES_HF0"] = SCORUM_MAX_RUNNER_WITNESSES_HF0;
   result["SCORUM_MAX_RUNNER_WITNESSES_HF17"] = SCORUM_MAX_RUNNER_WITNESSES_HF17;
   ...
   result["SCORUM_MAX_VOTED_WITNESSES_HF0"] = SCORUM_MAX_VOTED_WITNESSES_HF0;
   result["SCORUM_MAX_VOTED_WITNESSES_HF17"] = SCORUM_MAX_VOTED_WITNESSES_HF17;
   ...
   result["SCORUM_MINER_ACCOUNT"] = SCORUM_MINER_ACCOUNT;
   result["SCORUM_MINER_PAY_PERCENT"] = SCORUM_MINER_PAY_PERCENT;
   ...
   result["SCORUM_MIN_LIQUIDITY_REWARD"] = SCORUM_MIN_LIQUIDITY_REWARD;
   result["SCORUM_MIN_LIQUIDITY_REWARD_PERIOD_SEC"] = SCORUM_MIN_LIQUIDITY_REWARD_PERIOD_SEC;
   result["SCORUM_MIN_PAYOUT_SBD"] = SCORUM_MIN_PAYOUT_SBD;
   result["SCORUM_MIN_POW_REWARD"] = SCORUM_MIN_POW_REWARD;
   result["SCORUM_MIN_PRODUCER_REWARD"] = SCORUM_MIN_PRODUCER_REWARD;
   result["SCORUM_MIN_RATION"] = SCORUM_MIN_RATION;
   result["SCORUM_MIN_TRANSACTION_EXPIRATION_LIMIT"] = SCORUM_MIN_TRANSACTION_EXPIRATION_LIMIT;
   result["SCORUM_MIN_TRANSACTION_SIZE_LIMIT"] = SCORUM_MIN_TRANSACTION_SIZE_LIMIT;
   result["SCORUM_MIN_UNDO_HISTORY"] = SCORUM_MIN_UNDO_HISTORY;
   result["SCORUM_NULL_ACCOUNT"] = SCORUM_NULL_ACCOUNT;
   result["SCORUM_NUM_INIT_MINERS"] = SCORUM_NUM_INIT_MINERS;
   result["SCORUM_ORIGINAL_MIN_ACCOUNT_CREATION_FEE"] = SCORUM_ORIGINAL_MIN_ACCOUNT_CREATION_FEE;
   ...
   result["SCORUM_OWNER_CHALLENGE_COOLDOWN"] = SCORUM_OWNER_CHALLENGE_COOLDOWN;
   result["SCORUM_OWNER_CHALLENGE_FEE"] = SCORUM_OWNER_CHALLENGE_FEE;
   result["SCORUM_OWNER_UPDATE_LIMIT"] = SCORUM_OWNER_UPDATE_LIMIT;
   result["SCORUM_POST_AVERAGE_WINDOW"] = SCORUM_POST_AVERAGE_WINDOW;
   result["SCORUM_POST_MAX_BANDWIDTH"] = SCORUM_POST_MAX_BANDWIDTH;
   result["SCORUM_POST_REWARD_FUND_NAME"] = SCORUM_POST_REWARD_FUND_NAME;
   result["SCORUM_POST_WEIGHT_CONSTANT"] = SCORUM_POST_WEIGHT_CONSTANT;
   ...
   result["SCORUM_SBD_INTEREST_COMPOUND_INTERVAL_SEC"] = SCORUM_SBD_INTEREST_COMPOUND_INTERVAL_SEC;
   result["SCORUM_SECONDS_PER_YEAR"] = SCORUM_SECONDS_PER_YEAR;
   result["SCORUM_RECENT_RSHARES_DECAY_RATE_HF19"] = SCORUM_RECENT_RSHARES_DECAY_RATE_HF19;
   result["SCORUM_RECENT_RSHARES_DECAY_RATE_HF17"] = SCORUM_RECENT_RSHARES_DECAY_RATE_HF17;
   ...
   result["SCORUM_SBD_START_PERCENT"] = SCORUM_SBD_START_PERCENT;
   result["SCORUM_SBD_STOP_PERCENT"] = SCORUM_SBD_STOP_PERCENT;
   ...
   result["SCORUM_UPVOTE_LOCKOUT_HF7"] = SCORUM_UPVOTE_LOCKOUT_HF7;
   result["SCORUM_UPVOTE_LOCKOUT_HF17"] = SCORUM_UPVOTE_LOCKOUT_HF17;
   ...
   result["SCORUM_VOTE_CHANGE_LOCKOUT_PERIOD"] = SCORUM_VOTE_CHANGE_LOCKOUT_PERIOD;
