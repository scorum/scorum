...
// clang-format off
    ...
    result["SCORUM_LIMIT_BUDGETS_PER_OWNER"] = SCORUM_LIMIT_BUDGETS_PER_OWNER;
    result["SCORUM_LIMIT_FUND_BUDGETS"] = SCORUM_LIMIT_FUND_BUDGETS;
    result["SCORUM_LIMIT_BUDGETS_LIST_SIZE"] = SCORUM_LIMIT_BUDGETS_LIST_SIZE;
    result["SCORUM_LIMIT_API_BUDGETS_LIST_SIZE"] = SCORUM_LIMIT_API_BUDGETS_LIST_SIZE;
