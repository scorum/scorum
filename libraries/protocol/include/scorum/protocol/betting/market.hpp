...
FC_REFLECT(scorum::protocol::betting::handicap, (threshold))
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_home)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_draw)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_away)
FC_REFLECT(scorum::protocol::betting::correct_score, (home)(away))
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_home)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_both)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_away)
FC_REFLECT(scorum::protocol::betting::total, (threshold))
FC_REFLECT(scorum::protocol::betting::total_goals_home, (threshold))
FC_REFLECT(scorum::protocol::betting::total_goals_away, (threshold))

FC_REFLECT_EMPTY(scorum::protocol::betting::result_home::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::result_home::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::result_draw::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::result_draw::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::result_away::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::result_away::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::round_home::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::round_home::no)
FC_REFLECT(scorum::protocol::betting::handicap::over, (threshold))
FC_REFLECT(scorum::protocol::betting::handicap::under, (threshold))
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_home::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_home::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_draw::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_draw::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_away::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::correct_score_away::no)
FC_REFLECT(scorum::protocol::betting::correct_score::yes, (home)(away))
FC_REFLECT(scorum::protocol::betting::correct_score::no, (home)(away))
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_home::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_home::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_both::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_both::no)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_away::yes)
FC_REFLECT_EMPTY(scorum::protocol::betting::goal_away::no)
FC_REFLECT(scorum::protocol::betting::total::over, (threshold))
FC_REFLECT(scorum::protocol::betting::total::under, (threshold))
FC_REFLECT(scorum::protocol::betting::total_goals_home::over, (threshold))
FC_REFLECT(scorum::protocol::betting::total_goals_home::under, (threshold))
FC_REFLECT(scorum::protocol::betting::total_goals_away::over, (threshold))
FC_REFLECT(scorum::protocol::betting::total_goals_away::under, (threshold))
