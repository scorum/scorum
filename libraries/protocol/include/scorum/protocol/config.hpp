...
#define SCORUM_BUDGET_LIMIT_DB_LIST_SIZE        SCORUM_BUDGETS_LIMIT_PER_OWNER
#define SCORUM_BUDGET_LIMIT_API_LIST_SIZE       SCORUM_BUDGETS_LIMIT_PER_OWNER
...
#define SCORUM_BUDGET_LIMIT_COUNT_PER_OWNER       1000000
...
#define SCORUM_WITNESS_PER_BLOCK_REWARD_PERCENT     SCORUM_PERCENT(5)
