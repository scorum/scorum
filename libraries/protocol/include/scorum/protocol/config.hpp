...
#define SCORUM_REGISTRATION_BONUS_LIMIT_PER_MEMBER_PER_N_BLOCK    asset( 10, VESTS_SYMBOL )
...
#define REGISTRATION_BONUS_SYMBOL SCORUM_REGISTRATION_BONUS_LIMIT_PER_MEMBER_PER_N_BLOCK.symbol
