...
#define SCORUM_COMMITTEE_QUORUM_PERCENT         (SCORUM_PERCENT(60))

#define SCORUM_MIN_QUORUM_VALUE_PERCENT         (SCORUM_PERCENT(50))
#define SCORUM_MAX_QUORUM_VALUE_PERCENT         (SCORUM_PERCENT(100))
