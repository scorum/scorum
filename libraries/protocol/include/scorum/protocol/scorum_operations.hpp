...
FC_REFLECT( scorum::protocol::cancel_game_operation, (moderator)(uuid) )
FC_REFLECT( scorum::protocol::update_game_markets_operation, (moderator)(uuid)(markets) )
FC_REFLECT( scorum::protocol::update_game_start_time_operation, (moderator)(uuid)(start_time) )
FC_REFLECT( scorum::protocol::post_game_results_operation, (moderator)(uuid)(wincases) )
