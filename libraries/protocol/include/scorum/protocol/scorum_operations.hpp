 ...
 *  The percent_scorum_dollars may be decreased, but never increased
 *
 */
struct comment_options_operation : public base_operation
{
    ...
    asset max_accepted_payout
        = asset(1000000000, SBD_SYMBOL); /// SBD value of the maximum payout this post will receive
    uint16_t percent_scorum_dollars
...
struct chain_properties
{
    ...
    uint16_t sbd_interest_rate = SCORUM_DEFAULT_SBD_INTEREST_RATE;
    ...
    void validate() const
    {
        ...
        FC_ASSERT(sbd_interest_rate <= SCORUM_100_PERCENT);
    }
};
 ...
 *  used to define the exchange rate between scorum and the dollar.
 */
...
/**
 *  This operation instructs the blockchain to start a conversion between SCORUM and SBD,
 *  The funds are deposited after SCORUM_CONVERSION_DELAY
 */
...
FC_REFLECT(scorum::protocol::limit_order_create_operation,
    (owner)(orderid)(amount_to_sell)(min_to_receive)(fill_or_kill)(expiration))
FC_REFLECT(scorum::protocol::limit_order_create2_operation,
...
FC_REFLECT(scorum::protocol::comment_options_operation,
    (author)(permlink)(max_accepted_payout)(percent_scorum_dollars)(allow_votes)(allow_curation_rewards)(extensions))

FC_REFLECT(scorum::protocol::escrow_transfer_operation,
    (from)(to)(sbd_amount)(scorum_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration));
...
FC_REFLECT(
    scorum::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(scorum_amount));
...
FC_REFLECT(scorum::protocol::claim_reward_balance_operation, (account)(reward_scorum)(reward_sbd)(reward_vests))
