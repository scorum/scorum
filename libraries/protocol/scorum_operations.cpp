...
void limit_order_cancel_operation::validate() const { validate_account_name(owner); }
...
void cancel_transfer_from_savings_operation::validate() const { validate_account_name(from); }
