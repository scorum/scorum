...
void development_committee_change_top_budgets_amount_operation::validate() const
{
    FC_ASSERT(amount > 0u, "Top budgets amount must nozero");
}

percent_type
development_committee_change_top_budgets_amount_operation::get_required_quorum(committee_i& committee_service) const
{
