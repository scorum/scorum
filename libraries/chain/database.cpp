...
void database::initialize_evaluators()
{
    ...
    _my->_evaluator_registry.register_evaluator<vote_for_registration_committee_proposal_evaluator>();
    _my->_evaluator_registry.register_evaluator<create_committee_proposal_evaluator>();
}
