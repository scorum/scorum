...
adjust_nft_experience_evaluator::adjust_nft_experience_evaluator(data_service_factory_i& services,
                                                                 dba::db_accessor<account_object>& account_dba,
                                                                 dba::db_accessor<nft_object>& nft_dba)
    : evaluator_impl<data_service_factory_i, adjust_nft_experience_evaluator>(services)
...
void adjust_nft_experience_evaluator::do_apply(const operation_type& op)
{
    ...
    _nft_dba.update(nft, [&](auto& nft) { nft.experience += op.experience; });
}
