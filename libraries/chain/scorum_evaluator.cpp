...
void comment_options_evaluator::do_apply(const comment_options_operation& o)
{
    ...
    FC_ASSERT(
        comment.percent_scorum_dollars >= o.percent_scorum_dollars, "A comment cannot accept a greater percent SBD.");
...
void transfer_from_savings_evaluator::do_apply(const transfer_from_savings_operation& op)
{
    ...
    FC_ASSERT(from.savings_withdraw_requests < SCORUM_SAVINGS_WITHDRAW_REQUEST_LIMIT,
    ...
    _db.modify(from, [&](account_object& a) { a.savings_withdraw_requests++; });
}
