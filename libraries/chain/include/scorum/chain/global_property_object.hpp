...
FC_REFLECT(
    ...
    (id)(head_block_number)(head_block_id)(time)(current_witness)(total_pow)(num_pow_witnesses)(virtual_supply)(
        current_supply)(confidential_supply)(current_sbd_supply)(confidential_sbd_supply)(total_vesting_fund_scorum)(
        total_vesting_shares)(total_reward_fund_scorum)(total_reward_shares2)(pending_rewarded_vesting_shares)(
        pending_rewarded_vesting_scorum)(sbd_interest_rate)(sbd_print_rate)(maximum_block_size)(current_aslot)(
