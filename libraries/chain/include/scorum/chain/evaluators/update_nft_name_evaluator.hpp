...
class update_nft_name_evaluator : public evaluator_impl<data_service_factory_i, update_nft_name_evaluator>
{
public:
    using operation_type = scorum::protocol::update_nft_name_operation;

    update_nft_name_evaluator(data_service_factory_i&,
