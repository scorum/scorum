...
class create_game_round_evaluator : public evaluator_impl<data_service_factory_i, create_game_round_evaluator>
{
public:
    using operation_type = scorum::protocol::create_game_round_operation;
