...
class adjust_nft_experience_evaluator : public evaluator_impl<data_service_factory_i, adjust_nft_experience_evaluator>
{
public:
    using operation_type = scorum::protocol::adjust_nft_experience_operation;

    adjust_nft_experience_evaluator(data_service_factory_i&,
