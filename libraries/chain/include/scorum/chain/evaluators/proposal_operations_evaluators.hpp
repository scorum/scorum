...
//        : evaluator_impl<data_service_factory_i, proposal_evaluator_impl<OperationType>,
//        protocol::proposal_operation>(
//              factory)
//    {
//    }
...
// template <typename OperationType> struct proposal_add_member_evaluator : public
// proposal_evaluator_impl<OperationType>
//{
//    typedef OperationType operation_type;
...
// template <typename OperationType>
// struct proposal_exlude_member_evaluator : public proposal_evaluator_impl<OperationType>
//{
//    typedef OperationType operation_type;

//    proposal_exlude_member_evaluator(data_service_factory_i& factory)
//        : proposal_evaluator_impl<OperationType>(factory)
//    {
//    }
