...
struct matched_bet_service_i : public base_service_i<matched_bet_object>
{
    ...
    virtual std::vector<object_cref_type> get_bets_by_fst_better(bet_id_type bet_id) const = 0;
    virtual std::vector<object_cref_type> get_bets_by_snd_better(bet_id_type bet_id) const = 0;
...
public:
    ...
    virtual std::vector<object_cref_type> get_bets_by_fst_better(bet_id_type bet_id) const override;
    virtual std::vector<object_cref_type> get_bets_by_snd_better(bet_id_type bet_id) const override;
