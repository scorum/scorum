...
struct withdraw_vesting_route_service_i
{
    ...
    virtual bool is_exists(dev_committee_id_type from, dev_committee_id_type to) const = 0;
    ...
    virtual const withdraw_vesting_route_object& get(dev_committee_id_type from, dev_committee_id_type to) const = 0;
    ...
    virtual uint16_t total_percent(dev_committee_id_type from) const = 0;
};
...
public:
    ...
    virtual bool is_exists(dev_committee_id_type from, dev_committee_id_type to) const override;
    ...
    virtual const withdraw_vesting_route_object& get(dev_committee_id_type from,
                                                     dev_committee_id_type to) const override;
    ...
    virtual uint16_t total_percent(dev_committee_id_type from) const override;
...
bool is_from_account(const withdraw_vesting_route_object&);
bool is_to_account(const withdraw_vesting_route_object&);
bool is_from_dev_committee(const withdraw_vesting_route_object&);
