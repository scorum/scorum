...
#define TEST_INITIAL_SUPPLY asset(10000000000ll)
#define TEST_REWARD_INITIAL_SUPPLY asset(SCORUM_REWARDS_INITIAL_SUPPLY_PERIOD_IN_DAYS* SCORUM_BLOCKS_PER_DAY * 100)
