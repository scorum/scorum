...
struct fixture : public shared_memory_fixture
{
        ...
        : shared_memory_fixture()
    {
        ...
        mocks.ExpectCall(services, data_service_factory_i::dynamic_global_property_service).ReturnByRef(*dyn_props_service);
    }
};
...
BOOST_FIXTURE_TEST_CASE(decrease_dev_pool_scr_balance, fixture)
{
    ...
    mocks.ExpectCallOverload(dyn_props_service, (void(dgps_t::*)(const dgps_t::modifier_type&))&dgps_t::update).With(_);
