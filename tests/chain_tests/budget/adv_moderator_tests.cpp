...
namespace adv_moderator_tests {

using namespace budget_check_common;

class adv_moderator_fixture : public budget_check_fixture
{
public:
    adv_moderator_fixture()
    ...
    void empower_adv_moderator(const Actor& moderator_acc)
    {
        development_committee_empower_adv_moderator_operation empower_moder_op;
...
BOOST_FIXTURE_TEST_SUITE(adv_moderator_close_budget_tests, adv_moderator_fixture)
...
SCORUM_TEST_CASE(should_close_post_budget)
{
    ...
    empower_adv_moderator(moder);

    close_budget_by_adv_moderator_operation close_budget_op;
...
SCORUM_TEST_CASE(check_moderator_changing)
{
    ...
    empower_adv_moderator(bob); // now 'bob' became moderator ('moder' is not)
...
SCORUM_TEST_CASE(should_throw_moderator_not_exists)
{
    ...
    close_budget_by_adv_moderator_operation op;
