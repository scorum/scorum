...
BOOST_AUTO_TEST_CASE( comment_payout_equalize )
{
   try
   {
      ...
      for( const auto& author : authors )
      {
         ...
         ilog( "${n} : ${scorum} ${sbd}", ("n", author.name)("scorum", a.reward_scorum_balance)("sbd", a.reward_sbd_balance) );
      }
      for( const auto& voter : voters )
      {
         const account_object& a = db.get_account(voter.name);
         ilog( "${n} : ${scorum} ${sbd}", ("n", voter.name)("scorum", a.reward_scorum_balance)("sbd", a.reward_sbd_balance) );
      }
      */
...
/*BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto bob_comment_payout = asset( ( ( uint128_t( bob_comment_rshares.value ) * bob_comment_rshares.value * reward_scorum.amount.value ) / total_rshares2 ).to_uint64(), SCORUM_SYMBOL );
      ...
      auto bob_comment_vesting_reward = ( bob_comment_payout - asset( bob_comment_payout.amount / 2, SCORUM_SYMBOL) ) * db.get_dynamic_global_properties().get_vesting_share_price();
...
BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      generate_blocks( fc::time_point_sec( db.head_block_time().sec_since_epoch() + SCORUM_CASHOUT_WINDOW_SECONDS / 2 ), true );
      ...
      auto alice_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "bob", string( "test" ).id, db.get_account( "alice" ) ).id ) )->weight ) * bob_comment_vote_rewards.amount.value ) / bob_comment_vote_total ), SCORUM_SYMBOL );
      auto alice_vote_vesting = alice_vote_reward * db.get_dynamic_global_properties().get_vesting_share_price();
      auto bob_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "bob", string( "test" ).id, db.get_account( "bob" ) ).id ) )->weight ) * bob_comment_vote_rewards.amount.value ) / bob_comment_vote_total ), SCORUM_SYMBOL );
      auto bob_vote_vesting = bob_vote_reward * db.get_dynamic_global_properties().get_vesting_share_price();
      auto sam_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "bob", string( "test" ).id, db.get_account( "sam" ) ).id ) )->weight ) * bob_comment_vote_rewards.amount.value ) / bob_comment_vote_total ), SCORUM_SYMBOL );
      ...
      BOOST_REQUIRE( db.get_dynamic_global_properties().total_reward_fund_scorum.amount.value == reward_scorum.amount.value - ( bob_comment_payout + bob_comment_vote_rewards - unclaimed_payments ).amount.value );
      ...
      auto alice_comment_vesting_reward = ( alice_comment_payout - asset( alice_comment_payout.amount / 2, SCORUM_SYMBOL ) ) * db.get_dynamic_global_properties().get_vesting_share_price();
      unclaimed_payments = alice_comment_vote_rewards;
      alice_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "alice", string( "test" ).id, db.get_account( "alice" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), SCORUM_SYMBOL );
      alice_vote_vesting = alice_vote_reward * db.get_dynamic_global_properties().get_vesting_share_price();
      bob_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "alice", string( "test" ).id, db.get_account( "bob" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), SCORUM_SYMBOL );
      bob_vote_vesting = bob_vote_reward * db.get_dynamic_global_properties().get_vesting_share_price();
      sam_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "alice", string( "test" ).id, db.get_account( "sam" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), SCORUM_SYMBOL );
      sam_vote_vesting = sam_vote_reward * db.get_dynamic_global_properties().get_vesting_share_price();
      auto dave_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "alice", string( "test" ).id, db.get_account( "dave" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), SCORUM_SYMBOL );
      ...
      BOOST_REQUIRE( ( db.get_dynamic_global_properties().total_reward_fund_scorum + alice_comment_payout + alice_comment_vote_rewards - unclaimed_payments ).amount.value == reward_scorum.amount.value );
...
BOOST_AUTO_TEST_CASE( nested_comments )
{
   try
   {
      ...
      generate_blocks( db.get_comment( "alice", string( "test" ) ).cashout_time - fc::seconds( SCORUM_BLOCK_INTERVAL ), true );
      ...
      auto alice_comment_reward = ( ( reward_scorum * alice_comment.net_rshares.value * alice_comment.net_rshares.value ) / total_rshares2 ).to_uint64();
      ...
      auto alice_vote_alice_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "alice", string( "test" ).id, db.get_account( "alice" ) ).id ) )->weight ) * alice_comment_vote_rewards ) / alice_comment.total_vote_weight ), SCORUM_SYMBOL );
      auto bob_vote_alice_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "alice", string( "test" ).id, db.get_account( "bob" ) ).id ) )->weight ) * alice_comment_vote_rewards ) / alice_comment.total_vote_weight ), SCORUM_SYMBOL );
      reward_scorum += alice_comment_vote_rewards - ( alice_vote_alice_reward + bob_vote_alice_reward ).amount.value;

      auto bob_comment_reward = ( ( reward_scorum * bob_comment.net_rshares.value * bob_comment.net_rshares.value ) / total_rshares2 ).to_uint64();
      ...
      auto alice_vote_bob_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "bob", string( "test" ).id, db.get_account( "alice" ) ).id ) )->weight ) * bob_comment_vote_rewards ) / bob_comment.total_vote_weight ), SCORUM_SYMBOL );
      auto bob_vote_bob_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "bob", string( "test" ).id, db.get_account( "bob" ) ).id ) )->weight ) * bob_comment_vote_rewards ) / bob_comment.total_vote_weight ), SCORUM_SYMBOL );
      auto sam_vote_bob_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "bob", string( "test" ).id, db.get_account( "sam" ) ).id ) )->weight ) * bob_comment_vote_rewards ) / bob_comment.total_vote_weight ), SCORUM_SYMBOL );
      reward_scorum += bob_comment_vote_rewards - ( alice_vote_bob_reward + bob_vote_bob_reward + sam_vote_bob_reward ).amount.value;

      auto dave_comment_reward = ( ( reward_scorum * dave_comment.net_rshares.value * dave_comment.net_rshares.value ) / total_rshares2 ).to_uint64();
      ...
      auto bob_vote_dave_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db.get_comment( "dave", string( "test" ).id, db.get_account( "bob" ) ).id ) )->weight ) * dave_comment_vote_rewards ) / dave_comment.total_vote_weight ), SCORUM_SYMBOL );
      reward_scorum += dave_comment_vote_rewards - bob_vote_dave_reward.amount.value;
      ...
      auto alice_total_sbd = alice_starting_sbd + asset( alice_pays_alice_sbd + bob_pays_alice_sbd + dave_pays_alice_sbd, SCORUM_SYMBOL ) * exchange_rate;
      auto alice_total_vesting = alice_starting_vesting + asset( alice_pays_alice_vest + bob_pays_alice_vest + dave_pays_alice_vest + alice_vote_alice_reward.amount + alice_vote_bob_reward.amount, SCORUM_SYMBOL ) * gpo.get_vesting_share_price();
      ...
      auto bob_total_sbd = bob_starting_sbd + asset( bob_pays_bob_sbd + dave_pays_bob_sbd, SCORUM_SYMBOL ) * exchange_rate;
      auto bob_total_vesting = bob_starting_vesting + asset( bob_pays_bob_vest + dave_pays_bob_vest + bob_vote_alice_reward.amount + bob_vote_bob_reward.amount + bob_vote_dave_reward.amount, SCORUM_SYMBOL ) * gpo.get_vesting_share_price();
      ...
      auto sam_total_vesting = bob_starting_vesting + asset( dave_pays_sam_vest + sam_vote_bob_reward.amount, SCORUM_SYMBOL ) * gpo.get_vesting_share_price();
      ...
      auto dave_total_vesting = dave_starting_vesting + asset( dave_pays_dave_vest, SCORUM_SYMBOL ) * gpo.get_vesting_share_price();
   ...
   try
   {
      ...
      for( int i = 1; i < SCORUM_VESTING_WITHDRAW_INTERVALS - 1; i++ )
      {
         ...
         if ( i == SCORUM_VESTING_WITHDRAW_INTERVALS - 1 )
            ...
            BOOST_REQUIRE( alice.next_vesting_withdrawal.sec_since_epoch() == ( old_next_vesting + SCORUM_VESTING_WITHDRAW_INTERVAL_SECONDS ).sec_since_epoch() );
      ...
      if (  to_withdraw.amount.value % withdraw_rate.amount.value != 0 )
      {
         ...
         BOOST_REQUIRE( db.get_account( "alice" ).next_vesting_withdrawal.sec_since_epoch() == ( old_next_vesting + SCORUM_VESTING_WITHDRAW_INTERVAL_SECONDS ).sec_since_epoch() );
         BOOST_REQUIRE( fill_op.from_account == "alice" );
         BOOST_REQUIRE( fill_op.to_account == "alice" );
         BOOST_REQUIRE( fill_op.withdrawn.amount.value == withdraw_rate.amount.value );
         BOOST_REQUIRE( std::abs( ( fill_op.deposited - fill_op.withdrawn * gpo.get_vesting_share_price() ).amount.value ) <= 1 );
...
BOOST_AUTO_TEST_CASE( vesting_withdraw_route )
{
   try
   {
...

      {
         ...
         BOOST_REQUIRE( alice.balance == old_alice_balance + asset( ( vesting_withdraw_rate.amount * SCORUM_1_PERCENT * 20 ) / SCORUM_100_PERCENT, VESTS_SYMBOL ) * db.get_dynamic_global_properties().get_vesting_share_price() );
         BOOST_REQUIRE( bob.vesting_shares == old_bob_vesting + asset( ( vesting_withdraw_rate.amount * SCORUM_1_PERCENT * 50 ) / SCORUM_100_PERCENT, VESTS_SYMBOL ) );
         BOOST_REQUIRE( bob.balance == old_bob_balance );
         BOOST_REQUIRE( sam.vesting_shares == old_sam_vesting );
         BOOST_REQUIRE( sam.balance ==  old_sam_balance + asset( ( vesting_withdraw_rate.amount * SCORUM_1_PERCENT * 30 ) / SCORUM_100_PERCENT, VESTS_SYMBOL ) * db.get_dynamic_global_properties().get_vesting_share_price() );
      ...
      generate_blocks( db.get_account( "alice" ).next_vesting_withdrawal, true );
      {
         ...
         BOOST_REQUIRE( bob.balance == old_bob_balance );
         BOOST_REQUIRE( sam.vesting_shares == old_sam_vesting );
         BOOST_REQUIRE( sam.balance ==  old_sam_balance + asset( ( vesting_withdraw_rate.amount * SCORUM_1_PERCENT * 50 ) / SCORUM_100_PERCENT, VESTS_SYMBOL ) * db.get_dynamic_global_properties().get_vesting_share_price() );
      }
   }
   FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE( feed_publish_mean )
{
   try
   {
      ...
      generate_blocks( 30 / SCORUM_BLOCK_INTERVAL );
      ...
      ops[0].exchange_rate = price( asset( 100000, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );
      ops[1].exchange_rate = price( asset( 105000, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );
      ops[2].exchange_rate = price( asset(  98000, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );
      ops[3].exchange_rate = price( asset(  97000, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );
      ops[4].exchange_rate = price( asset(  99000, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );
      ops[5].exchange_rate = price( asset(  97500, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );
      ops[6].exchange_rate = price( asset( 102000, SCORUM_SYMBOL ), asset( 1000, SBD_SYMBOL ) );

      for( int i = 0; i < 7; i++ )
      {
         txs[i].set_expiration( db.head_block_time() + SCORUM_MAX_TIME_UNTIL_EXPIRATION );
      ...
      generate_blocks( SCORUM_BLOCKS_PER_HOUR ); // Jump forward 1 hour
      ...
      BOOST_REQUIRE( feed_history.current_median_history == price( asset( 99000, SCORUM_SYMBOL), asset( 1000, SBD_SYMBOL ) ) );
      BOOST_REQUIRE( feed_history.price_history[ 0 ] == price( asset( 99000, SCORUM_SYMBOL), asset( 1000, SBD_SYMBOL ) ) );
      validate_database();
      ...
      for ( int i = 0; i < 23; i++ )
      {
         ...
         for( int j = 0; j < 7; j++ )
         {
            ...
            txs[j].set_expiration( db.head_block_time() + SCORUM_MAX_TIME_UNTIL_EXPIRATION );
...
BOOST_AUTO_TEST_CASE( convert_delay )
{
   try
   {
      ...
      generate_blocks( db.head_block_time() + SCORUM_CONVERSION_DELAY - fc::seconds( SCORUM_BLOCK_INTERVAL / 2 ), true );
...
BOOST_AUTO_TEST_CASE( scorum_inflation )
{
   try
   {
   /*
      BOOST_TEST_MESSAGE( "Testing SCORUM Inflation until the vesting start block" );
      ...
      auto new_rewards = std::max( SCORUM_MIN_CONTENT_REWARD, asset( ( SCORUM_CONTENT_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) )
         + std::max( SCORUM_MIN_CURATE_REWARD, asset( ( SCORUM_CURATE_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) );
      auto witness_pay = std::max( SCORUM_MIN_PRODUCER_REWARD, asset( ( SCORUM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) );
      auto witness_pay_shares = asset( 0, VESTS_SYMBOL );
      auto new_vesting_scorum = asset( 0, SCORUM_SYMBOL );
      auto new_vesting_shares = gpo.total_vesting_shares;

      if ( db.get_account( witness_name ).vesting_shares.amount.value == 0 )
      {
         new_vesting_scorum += witness_pay;
         new_vesting_shares += witness_pay * ( gpo.total_vesting_shares / gpo.total_vesting_fund_scorum );
      }

      auto new_supply = gpo.current_supply + new_rewards + witness_pay + new_vesting_scorum;
      new_rewards += gpo.total_reward_fund_scorum;
      new_vesting_scorum += gpo.total_vesting_fund_scorum;
      ...
      BOOST_REQUIRE( gpo.total_reward_fund_scorum.amount.value == new_rewards.amount.value );
      BOOST_REQUIRE( gpo.total_vesting_fund_scorum.amount.value == new_vesting_scorum.amount.value );
      ...
      while( db.head_block_num() < SCORUM_START_VESTING_BLOCK - 1)
      {
         ...
         new_rewards = std::max( SCORUM_MIN_CONTENT_REWARD, asset( ( SCORUM_CONTENT_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) )
            + std::max( SCORUM_MIN_CURATE_REWARD, asset( ( SCORUM_CURATE_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) );
         witness_pay = std::max( SCORUM_MIN_PRODUCER_REWARD, asset( ( SCORUM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) );
         new_vesting_scorum = asset( 0, SCORUM_SYMBOL );
         ...
         if ( db.get_account( witness_name ).vesting_shares.amount.value == 0 )
         {
            ...
            witness_pay = asset( 0, SCORUM_SYMBOL );
         }

         new_supply = gpo.current_supply + new_rewards + witness_pay + new_vesting_scorum;
         new_rewards += gpo.total_reward_fund_scorum;
         new_vesting_scorum += gpo.total_vesting_fund_scorum;
      ...
      while( db.head_block_num() < SCORUM_START_MINER_VOTING_BLOCK - 1 )
      {
         virtual_supply = gpo.virtual_supply;
         witness_name = db.get_scheduled_witness(1);
         old_witness_balance = db.get_account( witness_name ).balance;
         ...
         witness_pay = std::max( SCORUM_MIN_PRODUCER_REWARD, asset( ( SCORUM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) );
         auto witness_pay_shares = asset( 0, VESTS_SYMBOL );
         new_vesting_scorum = asset( ( witness_pay + new_rewards ).amount * 9, SCORUM_SYMBOL );
         new_vesting_shares = gpo.total_vesting_shares;
      ...
      for( int i = 0; i < SCORUM_BLOCKS_PER_DAY; i++ )
      {
         virtual_supply = gpo.virtual_supply;
         witness_name = db.get_scheduled_witness(1);
         old_witness_balance = db.get_account( witness_name ).balance;
         ...
         witness_pay = std::max( SCORUM_MIN_PRODUCER_REWARD, asset( ( SCORUM_PRODUCER_APR * gpo.virtual_supply.amount ) / ( SCORUM_BLOCKS_PER_YEAR * 100 ), SCORUM_SYMBOL ) );
         witness_pay_shares = witness_pay * gpo.get_vesting_share_price();
         new_vesting_scorum = asset( ( witness_pay + new_rewards ).amount * 9, SCORUM_SYMBOL ) + witness_pay;
         new_vesting_shares = gpo.total_vesting_shares + witness_pay_shares;
         new_supply = gpo.current_supply + new_rewards + new_vesting_scorum;
         new_rewards += gpo.total_reward_fund_scorum;
         new_vesting_scorum += gpo.total_vesting_fund_scorum;
      ...
      vesting_scorum = gpo.total_vesting_fund_scorum;
      reward_scorum = gpo.total_reward_fund_scorum;
      ...
      BOOST_REQUIRE_EQUAL( gpo.total_vesting_fund_scorum.amount.value,
         ( vesting_scorum.amount.value
            + ( ( ( uint128_t( virtual_supply.amount.value ) / 10 ) / SCORUM_BLOCKS_PER_YEAR ) * 9 )
            + ( uint128_t( virtual_supply.amount.value ) / 100 / SCORUM_BLOCKS_PER_YEAR ) ).to_uint64() );
      BOOST_REQUIRE_EQUAL( gpo.total_reward_fund_scorum.amount.value,
         reward_scorum.amount.value + virtual_supply.amount.value / 10 / SCORUM_BLOCKS_PER_YEAR + virtual_supply.amount.value / 10 / SCORUM_BLOCKS_PER_DAY );
      BOOST_REQUIRE_EQUAL( db.get_account( witness_name ).vesting_shares.amount.value,
         old_witness_shares.amount.value + ( asset( ( ( virtual_supply.amount.value / SCORUM_BLOCKS_PER_YEAR ) * SCORUM_1_PERCENT ) / SCORUM_100_PERCENT, SCORUM_SYMBOL ) * ( vesting_shares / vesting_scorum ) ).amount.value );
      validate_database();
      */
   }
   FC_LOG_AND_RETHROW();
...
BOOST_AUTO_TEST_CASE( sbd_interest )
{
   try
   {
      ...
      generate_blocks( db.head_block_time() + fc::seconds( SCORUM_SBD_INTEREST_COMPOUND_INTERVAL_SEC ), true );
      ...
      BOOST_REQUIRE( db.get_account( "alice" ).sbd_balance.amount.value == alice_sbd.amount.value - ASSET( "1.000 TBD" ).amount.value + ( ( ( ( uint128_t( alice_sbd.amount.value ) * ( db.head_block_time() - start_time ).to_seconds() ) / SCORUM_SECONDS_PER_YEAR ) * gpo.sbd_interest_rate ) / SCORUM_100_PERCENT ).to_uint64() );
      ...
      generate_blocks( db.head_block_time() + fc::seconds( SCORUM_SBD_INTEREST_COMPOUND_INTERVAL_SEC / 2 ), true );
      ...
      generate_blocks( db.head_block_time() + fc::seconds( ( SCORUM_SBD_INTEREST_COMPOUND_INTERVAL_SEC * 7 ) / 3 ), true );
      ...
      BOOST_REQUIRE( db.get_account( "alice" ).sbd_balance.amount.value == alice_sbd.amount.value - ASSET( "1.000 TBD" ).amount.value + ( ( ( ( uint128_t( alice_sbd.amount.value ) * ( db.head_block_time() - start_time ).to_seconds() + alice_coindays ) / SCORUM_SECONDS_PER_YEAR ) * gpo.sbd_interest_rate ) / SCORUM_100_PERCENT ).to_uint64() );
      validate_database();
   }
   FC_LOG_AND_RETHROW();
}
...
BOOST_AUTO_TEST_CASE( liquidity_rewards )
{
   ...
   try
   {
      ...
      generate_blocks( db.head_block_time() + SCORUM_MIN_LIQUIDITY_REWARD_PERIOD_SEC, true );
      ...
      alice_scorum_volume += ( asset( alice_sbd.amount / 20, SBD_SYMBOL ) * exchange_rate ).amount.value;
      alice_reward_last_update = db.head_block_time();
      bob_scorum_volume -= ( asset( alice_sbd.amount / 20, SBD_SYMBOL ) * exchange_rate ).amount.value;
      ...
      BOOST_REQUIRE( reward->scorum_volume == alice_scorum_volume );
      ...
      BOOST_REQUIRE( reward->scorum_volume == bob_scorum_volume );
      ...
      op.owner = "sam";
      op.amount_to_sell = asset( ( alice_sbd.amount.value / 20 ), SCORUM_SYMBOL );
      ...
      op.owner = "bob";
      op.orderid = 4;
      op.amount_to_sell = asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, SCORUM_SYMBOL );
      ...
      op.min_to_receive = asset( ( alice_sbd.amount.value / 10 ) * 3, SCORUM_SYMBOL );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, SCORUM_SYMBOL ).amount.value );
      ...
      BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( alice_sbd.amount.value / 20, SCORUM_SYMBOL ).amount.value );
      BOOST_REQUIRE( fill_order_op.current_owner == "alice" );
      BOOST_REQUIRE( fill_order_op.current_orderid == 5 );
      ...
      BOOST_REQUIRE( reward->scorum_volume == sam_scorum_volume );
      ...
      op.min_to_receive = asset( alice_sbd.amount.value / 20 * 2, SCORUM_SYMBOL );
      ...
      generate_blocks( db.head_block_time() + fc::seconds( SCORUM_MIN_LIQUIDITY_REWARD_PERIOD_SEC.to_seconds() / 2 ), true );
      ...
      BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( alice_sbd.amount.value / 20, SCORUM_SYMBOL ).amount.value );
      ...
      alice_scorum_volume += alice_sbd.amount.value / 20;
      alice_reward_last_update = db.head_block_time();
      sam_scorum_volume -= alice_sbd.amount.value / 20;
      sam_reward_last_update = db.head_block_time();
      ...
      op.owner = "alice";
      op.amount_to_sell = asset( 8 * ( alice_sbd.amount.value / 20 ), SCORUM_SYMBOL );
      ...
      op.min_to_receive = asset( op.amount_to_sell.amount, SCORUM_SYMBOL );
      op.orderid = 10;
      tx.operations.clear();
      tx.signatures.clear();
      tx.operations.push_back( op );
      ...
      BOOST_REQUIRE( reward->scorum_volume == dave_scorum_volume );
      ...
      bob_scorum_volume += op.amount_to_sell.amount.value;
      bob_reward_last_update = db.head_block_time();
      dave_scorum_volume -= op.amount_to_sell.amount.value;
      dave_reward_last_update = db.head_block_time();
      ...
      generate_blocks( SCORUM_LIQUIDITY_REWARD_BLOCKS - ( db.head_block_num() % SCORUM_LIQUIDITY_REWARD_BLOCKS ) - 1 );

      BOOST_REQUIRE( db.head_block_num() % SCORUM_LIQUIDITY_REWARD_BLOCKS == SCORUM_LIQUIDITY_REWARD_BLOCKS - 1 );
      ...
      //alice_balance += SCORUM_MIN_LIQUIDITY_REWARD;
      ...
      SCORUM_REQUIRE_THROW( ops[0].get< liquidity_reward_operation>(), fc::exception );
      //BOOST_REQUIRE( ops[0].get< liquidity_reward_operation>().payout.amount.value == SCORUM_MIN_LIQUIDITY_REWARD.amount.value );

      generate_blocks( SCORUM_LIQUIDITY_REWARD_BLOCKS );

      //bob_balance += SCORUM_MIN_LIQUIDITY_REWARD;
      ...
      generate_blocks( sam_reward_last_update + SCORUM_LIQUIDITY_TIMEOUT_SEC - fc::seconds( SCORUM_BLOCK_INTERVAL / 2 ) - SCORUM_MIN_LIQUIDITY_REWARD_PERIOD_SEC , true );
      ...
      generate_blocks( db.head_block_time() + ( SCORUM_BLOCK_INTERVAL / 2 ) + SCORUM_LIQUIDITY_TIMEOUT_SEC, true );
      ...
      op.min_to_receive.symbol = SCORUM_SYMBOL;
      tx.operations.clear();
      tx.signatures.clear();
      tx.operations.push_back( op );
      tx.set_expiration( db.head_block_time() + SCORUM_MAX_TIME_UNTIL_EXPIRATION );
...
BOOST_AUTO_TEST_CASE( post_rate_limit )
{
   try
   {
      ...
      generate_blocks( db.head_block_time() + SCORUM_MIN_ROOT_COMMENT_INTERVAL + fc::seconds( SCORUM_BLOCK_INTERVAL ), true );
...
BOOST_AUTO_TEST_CASE( sbd_stability )
{
   try
   {
      ...
      BOOST_REQUIRE( db.get_dynamic_global_properties().sbd_print_rate == SCORUM_100_PERCENT );
      ...
      db_plugin->debug_generate_blocks_until( debug_key, fc::time_point_sec( db.get_comment( comment.author, comment.permlink ).cashout_time.sec_since_epoch() - 2 * SCORUM_BLOCK_INTERVAL ), true, database::skip_witness_signature );

      auto& gpo = db.get_dynamic_global_properties();

      BOOST_TEST_MESSAGE( "Changing sam and gpo to set up market cap conditions" );

      asset sbd_balance = asset( ( gpo.virtual_supply.amount * ( SCORUM_SBD_STOP_PERCENT + 30 ) ) / SCORUM_100_PERCENT, SCORUM_SYMBOL ) * exchange_rate;
      ...
      auto comment_reward = ( gpo.total_reward_fund_scorum.amount + 2000 ) - ( ( gpo.total_reward_fund_scorum.amount + 2000 ) * 25 * SCORUM_1_PERCENT ) / SCORUM_100_PERCENT ;
      comment_reward /= 2;
      auto sbd_reward = ( comment_reward * gpo.sbd_print_rate ) / SCORUM_100_PERCENT;
      auto alice_sbd = db.get_account( "alice" ).sbd_balance + db.get_account( "alice" ).reward_sbd_balance + asset( sbd_reward, SCORUM_SYMBOL ) * exchange_rate;
      auto alice_scorum = db.get_account( "alice" ).balance + db.get_account( "alice" ).reward_scorum_balance ;

      BOOST_TEST_MESSAGE( "Checking printing SBD has slowed" );
      BOOST_REQUIRE( db.get_dynamic_global_properties().sbd_print_rate < SCORUM_100_PERCENT );

      BOOST_TEST_MESSAGE( "Pay out comment and check rewards are paid as SCORUM" );
      db_plugin->debug_generate_blocks( debug_key, 1, database::skip_witness_signature );

      validate_database();

      BOOST_REQUIRE( db.get_account( "alice" ).sbd_balance + db.get_account( "alice" ).reward_sbd_balance == alice_sbd );
      BOOST_REQUIRE( db.get_account( "alice" ).balance + db.get_account( "alice" ).reward_scorum_balance > alice_scorum );
      ...
      while( ( db.get_dynamic_global_properties().current_sbd_supply * exchange_rate ).amount >= ( db.get_dynamic_global_properties().virtual_supply.amount * SCORUM_SBD_START_PERCENT ) / SCORUM_100_PERCENT )
      {
         auto& gpo = db.get_dynamic_global_properties();
...
BOOST_AUTO_TEST_CASE( sbd_price_feed_limit )
{
   try
   {
      ...
      auto new_exchange_rate = price( gpo.current_sbd_supply, asset( ( SCORUM_100_PERCENT ) * gpo.current_supply.amount ) );
...
BOOST_AUTO_TEST_CASE( clear_null_account )
{
   try
   {
      ...
      transfer2.to = SCORUM_NULL_ACCOUNT;
      ...
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).balance == ASSET( "1.000 TESTS" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).sbd_balance == ASSET( "2.000 TBD" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).vesting_shares > ASSET( "0.000000 VESTS" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).savings_balance == ASSET( "4.000 TESTS" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).savings_sbd_balance == ASSET( "5.000 TBD" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).reward_sbd_balance == ASSET( "1.000 TBD" ) );
      ...
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).sbd_balance == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).vesting_shares == ASSET( "0.000000 VESTS" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).savings_balance == ASSET( "0.000 TESTS" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).savings_sbd_balance == ASSET( "0.000 TBD" ) );
      BOOST_REQUIRE( db.get_account( SCORUM_NULL_ACCOUNT ).reward_sbd_balance == ASSET( "0.000 TBD" ) );
